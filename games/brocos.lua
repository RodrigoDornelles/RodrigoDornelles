...
local function render_broco(std, game, posX, posY, broco)
    ...
    elseif broco == 2 then -- diamond
        ...
        std.draw.poly(0, diamond1, 0, 0)
        std.draw.poly(0, diamond2, 0, 0)
        std.draw.poly(0, diamond3, 0, 0)
        std.draw.poly(0, diamond4, 0, 0)
        --std.draw.color(std.color.black)
    ...
    elseif broco == 3 then -- triangle
        ...
        std.draw.poly(0, triangleLeft, 0, 0)
        std.draw.poly(0, triangleRight, 0, 0)
    ...
    elseif broco == 5 then -- trapezoid
        ...
        std.draw.poly(0, trapezoid1, 0, 0)
        std.draw.poly(0, trapezoid2, 0, 0)
    ...
    elseif broco == 6 then -- star
        ...
        std.draw.poly(0, star1, 0, 0)
        std.draw.poly(0, star2, 0, 0)
        std.draw.poly(0, star3, 0, 0)
        --std.draw.color(std.color.black)
    ...
    elseif broco == 7 or broco == 8 then 
        ...
        std.draw.poly(0, fill1, 0, 0)
        std.draw.poly(0, fill2, 0, 0)
        std.draw.poly(0, fill3, 0, 0)
        std.draw.poly(0, fill4, 0, 0)
    end
end
